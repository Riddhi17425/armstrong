...
use App\Models\{ProductDescription, ProductFaq};
...
class ProductsController extends Controller
{
    ...
    public function productsByCategory($url)
    {
        ...
        return view('front.product', compact('metatitle','metadescription','category', 'products' , 'productsForJs'));
    }
    ...
    public function detail($url)
    {
        ...
        $productDescription = ProductDescription::whereNull('deleted_at')->where('product_master_id', $product->id)->first();
        $productFaqs = ProductFaq::whereNull('deleted_at')->where('product_master_id', $product->id)->get();    
        ...
        if ($product->is_live == 1) {
            ...
            return view('front.new_fibc-fabric-cutting-machine', compact(
                'product',
                'products',
                'metatitle',
                'metadescription',
