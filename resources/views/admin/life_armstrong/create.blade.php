        ...
        <div class="container-xxl">
            ...
            <div class="row clearfix g-3">
                <div class="col-sm-12">
                    <div class="card mb-3">
                        <div class="card-body">
                            <form action="{{ route('lifearmstrong.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                {{-- lifearmstrong Info --}}
                                    ...
                                    <div class="card-body row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="lifearmstrong_title"
                                                ...
                                                value="{{ old('lifearmstrong_title') }}" placeholder="Enter Title Here">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            @error('lifearmstrong_image')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div class="preview_lifearmstrong_image mt-2 d-flex flex-wrap gap-2 position-relative">
                                            </div>
                                            <img id="preview_lifearmstrong_image" src="#" alt="Preview" class="mt-2" style="max-width: 100%; height: auto; display: none;" />
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="lifearmstrong_status"
                                                ...
                                                <option value="Active"
                                                    {{ old('lifearmstrong_status') == 'Active' ? 'selected' : '' }}>Active
                                                </option>
                                                <option value="In-Active"
                                                    {{ old('lifearmstrong_status') == 'In-Active' ? 'selected' : '' }}>Inactive
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="lifearmstrong_alt"
                                                ...
                                                value="{{ old('lifearmstrong_alt') }}" placeholder="Enter Alt Here">
                                        ...
                                        <div class="card mb-4 border">
                                            <div class="card mb-4 border">
                                                ...
                                                <div class="card-body">
                                                    <textarea name="lifearmstrong_desc" class="form-control @error('lifearmstrong_desc') is-invalid @enderror" rows="4"
                                                        id="lifearmstrong_desc">{{ old('lifearmstrong_desc') }}</textarea>
