...
@section('content')
        ...
        <div class="container-xxl">
            ...
            <div class="row clearfix g-3">
                <div class="col-sm-12">
                    <div class="card mb-3">
                        <div class="card-body">
                            <table id="jobs_table" class="table table-hover align-middle mb-0" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Title</th>
    ...
    <script>
        window.APP_URLS = {
            getJobsdata: "{{ route('getJobsData') }}",
            getdata: "{{ route('getJobsData') }}",
            deletejobs:"{{ route('jobs.delete' , [':id']) }}",
