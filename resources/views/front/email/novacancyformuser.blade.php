        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
          ...
          <tr>
            <td colspan="2" style="padding:0 20px 20px 20px; font-family:Arial, sans-serif; color:#666666;">
              <h1 style="margin:0 0 10px 0; font-size:24px; font-weight:600; color:#111111; margin:20px 0 10px; text-align:center;">Thank You for Your Enquiry.</h1>
              <p style="margin:0; font-size:14px; line-height:22px;">
               Your application has been received by our hiring team! We regret to inform that there are no openings for any profile as of now. 
                You will surely receive a response as and when there are openings aligning to your expertise. 
                Thanks for connecting with Armstrong. Best of luck for the future.
              </p>
              <p>Best regards,</p>
              <p>Team Armstrong</p>
            </td>
