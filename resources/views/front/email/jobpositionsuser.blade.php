        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
          ...
          <tr>
            <td colspan="2" style="padding:0 20px 20px 20px; font-family:Arial, sans-serif; color:#666666;">
              <h1 style="margin:20px 0 10px; text-align:center; font-size:24px; font-weight:600; color:#111111;">Thank You for Your Enquiry.</h1>
              <p style="margin:0; font-size:14px; line-height:22px;">
               Thank you for applying for the open  position at Armstrong.
                  We have successfully received your application and our HR team will review it carefully.
                  If your qualifications match our requirements, we’ll reach out within 2-3 working days to discuss next steps.
                  In the meantime, you can learn more about our industrial machinery projects and company culture at our official website.
              </p>
              <p>Best regards,</p>
              <p>Team Armstrong</p>
            </td>
