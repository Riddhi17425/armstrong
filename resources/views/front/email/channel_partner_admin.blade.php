  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" align="center" style="max-width:600px; margin:0 auto;">
    ...
    <tr>      
      <td style="padding:34px 20px 37px 20px;">
        <h2 style="color:#111111; font-weight:600; font-size:18px; font-family:Arial, sans-serif; margin:20px 0 10px; text-align:center;">
          Hello Team,
        </h2>
        <p style="font-size:14px; line-height:20px; color:#333333; font-family:Arial, sans-serif; margin:0 0 10px;">
          A new channel partner enquiry has come in through the website form. <br>Please find the details below:
        </p>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #DDD; border-radius:5px; font-size:14px; color:#333; font-family:Arial, sans-serif;">
          <tr>
            ...
            <td style="border:1px solid #DDD; padding:8px 20px;">{{ $channelPartner->name }}</td>
          </tr>
          <tr>
            <td style="border:1px solid #DDD; padding:8px 20px; font-weight:bold;">Email:</td>
            <td style="border:1px solid #DDD; padding:8px 20px;">{{ $channelPartner->email }}</td>
          </tr>
          <tr>
            <td style="border:1px solid #DDD; padding:8px 20px; font-weight:bold;">Company Name:</td>
            <td style="border:1px solid #DDD; padding:8px 20px;">{{ $channelPartner->company_name }}</td>
          </tr>
          <tr>
            <td style="border:1px solid #DDD; padding:8px 20px; font-weight:bold;">Business Type:</td>
            <td style="border:1px solid #DDD; padding:8px 20px;">{{ $channelPartner->business_type }}</td>
          </tr>
          <tr>
            <td style="border:1px solid #DDD; padding:8px 20px; font-weight:bold;">Industry Segment:</td>
            <td style="border:1px solid #DDD; padding:8px 20px;">{{ $channelPartner->industry_segment }}</td>
          </tr>
          <tr>
            <td style="border:1px solid #DDD; padding:8px 20px; font-weight:bold;">Phone:</td>
            <td style="border:1px solid #DDD; padding:8px 20px;">{{ $channelPartner->contact }}</td>
          </tr>
          @if(!empty($channelPartner->message)) 
            <tr>
              <td style="border:1px solid #DDD; padding:8px 20px; font-weight:bold;">Message:</td>
              <td style="border:1px solid #DDD; padding:8px 20px;">{{ $channelPartner->message }}</td>
            </tr>
          @endif
        </table>
