...
<body style="margin:0; padding:0; background-color:#ffffff;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
          ...
          <tr>
            <td colspan="2" style="padding:0 20px 20px 20px; font-family:Arial, sans-serif; color:#666666;">
              <h1 style="margin:20px 0 10px 0; font-size:24px; font-weight:600; text-align:center; color:#111111;">Thank you for reaching out to Armstrong.</h1>
              <p style="margin:0; font-size:14px; line-height:22px;">
                <p>We’ve received your message and one of our industrial-machinery specialists will get back to you at the earliest.
                  If you’d like to share drawings, specs, or additional details to help us prepare, simply reply to this email and it will go straight to our team.</p>
                  <p>Best regards,</p>
                  <p>Team Armstrong</p>
              </p>
            </td>
  ...
  <td colspan="2" style="padding:20px;">
    ...
    <p style="font-size:14px; line-height:22px; color:#666666; margin:0 0 15px; text-align:center; font-family:Arial, sans-serif;">
     If you have drawings, capacity details, or other requirements to share, simply reply to this email and they will be added to your request.
    </p>
