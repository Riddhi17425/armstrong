  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" align="center" style="max-width:600px; margin:0 auto;">
      ...
      <td style="padding:30px 20px 15px 20px;">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
          <tr>
            ...
            <!-- Contact -->
            <td align="right" style="font-family:Arial, sans-serif; font-size:14px; color:#666666;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding-right:10px; border-right:1px solid #888888;">
                    <a href="tel:+916358740011" style="color:#666666; text-decoration:none;">
                      <strong style="color:#182653;">M :</strong> +91 63587 40011
                    </a><br>
                    <a href="tel:+916358740024" style="color:#666666; text-decoration:none;">
                      <strong style="color:#182653;">M :</strong> +91 63587 40024
                    </a>
                  </td>
                  <td style="padding-left:10px;">
                    <a href="tel:+916358740025" style="color:#666666; text-decoration:none;">
                      <strong style="color:#182653;">M :</strong> +91 63587 40025
                    </a><br>
                    <a href="mailto:inquiry@armstrongex.com" style="color:#666666; text-decoration:none;">
    ...
    <tr>
      <td style="padding:34px 20px 37px 20px;">
        <h2 style="color:#111111; font-weight:600; font-size:18px; font-family:Arial, sans-serif; margin:20px 0 10px; text-align:center;">Hello Team,</h2>
        <p style="font-size:14px; line-height:20px; color:#333333; font-family:Arial, sans-serif; margin:0 0 10px;">
          A new profile was shared. Go through the profile and document them for future references while hiring. <br>Please find the details below:
        </p>
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #DDD; border-radius:5px; font-size:14px; color:#333; font-family:Arial, sans-serif;">
          <tr>
            <td style="border:1px solid #DDD; padding:8px 20px; width:30%; font-weight:bold;">Fullname: </td>
          ...
          <tr>
            ...
            <td style="border:1px solid #DDD; padding:8px 20px;">{{ $data['phone'] }}</td>
          </tr>
          @if(!empty($data['current_location'])) 
            <tr>
              <td style="border:1px solid #DDD; padding:8px 20px; font-weight:bold;">Current Location: </td>
              <td style="border:1px solid #DDD; padding:8px 20px;">{{ $data['current_location'] }}</td>
            </tr>
          @endif
          @if(!empty($data['linkedin_profile']))
            <tr>
              <td style="border:1px solid #DDD; padding:8px 20px; font-weight:bold;">LinkedIn Profile: </td>
              <td style="border:1px solid #DDD; padding:8px 20px;">{{ $data['linkedin_profile'] }}</td>
            </tr>
          @endif
        </table>
      </td>
