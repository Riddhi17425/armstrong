...
<section class="section-pt">
   <div class="container">
      <div class="row gy-4 gy-lg-0 gx-lg-5 align-items-center">
         <div class="col-md-7">
            @if(strtolower($product->url) == 'auto-labelling-machines-for-pp-woven-sacks-for-bag-making-&-bag-closing-industries') 
            <div class="video_card_top">
                <img fetchpriority="high" src="{{ asset('/public/admin/product/videos/images/Frame-1.webp')}}" alt="Heat Sealing Machine" class="img-fluid">
                <a href="{{ asset('/public/front/img/Frame1.mp4')}}" data-fancybox="video-hero">
            ...
            @else
                ...
                <div id="product_details" class="owl-carousel owl-theme">
                    ...
                    <div class="text-center">
                        <img fetchpriority="high" src="{{ asset($image->image) }}" 
                             alt="product" 
