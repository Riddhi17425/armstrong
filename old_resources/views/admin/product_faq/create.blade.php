    ...
    <div class="container-xxl">
        ...
        <div class="row align-items-center">
            ...
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="fw-bold mb-0">Add Product Faqs</h3>
        ...
        <div class="row clearfix g-3">
            <div class="col-sm-12">
                <div class="card mb-3">
                    <div class="card-body">
                        <form id="prodcutForm" action="{{ route('product-faqs.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf                   
                            {{-- Product Info --}}
                            <div class="card mb-4 border">
                                <div class="card-header bg-light"><strong>Product FAQs Information</strong></div>
                            ...
                            <div class="text-end mt-4">
                                <button type="submit" class="btn btn-primary">Save Product Faqs</button>
                            </div>
                        </form>
                    </div> {{-- End Card Body --}}
                </div>
