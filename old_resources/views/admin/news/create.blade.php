...
@section('content')
                                ...
                                <div class="card mb-4 border">
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="file" name="front_image" class="form-control" id="news_front_image" @error('front_image') is-invalid @enderror">
                                            @error('front_image')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                             <img id="preview_news_image" src="#" alt="Preview" class="mt-2" style="max-width: 100%; height: auto; display: none;" />
                                        </div>

                                        {{-- Detail Image --}}
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Detail Image <span class="required-star">*</span></label>
                                            <input type="file" name="detail_image" id="news_detail_image" class="form-control @error('detail_image') is-invalid @enderror">
                                            @error('detail_image')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                             <img id="preview_news_image" src="#" alt="Preview" class="mt-2" style="max-width: 100%; height: auto; display: none;" />
    ...
    {{-- JS Section --}}
    <script src="{{ asset('public/admin/js/news/news.js') }}" defer></script>
