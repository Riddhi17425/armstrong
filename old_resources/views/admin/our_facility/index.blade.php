...
@section('content')
        ...
        <div class="container-xxl">
            <div class="row align-items-center">
                ...
                <div class="border-0 mb-4">
                    <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                        <h3 class="fw-bold mb-0">Our Facility</h3>
                        <div class="col-auto d-flex w-sm-100">
                            <a href="{{ route('ourfacility.addOurfacility') }}">
            ...
            <div class="row clearfix g-3">
                <div class="col-sm-12">
                    <div class="card mb-3">
                        <div class="card-body">
                            <table id="ourfacility_table" class="table table-hover align-middle mb-0" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Title</th>
    ...
    <script>
        window.APP_URLS = {
            getOurfacilitydata: "{{ route('getOurfacilityData') }}",
            deleteourfacility:"{{ route('ourfacility.delete' , [':id']) }}",
