...
@section('content')
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form id="prodcutForm" action="{{ route('product.update', $data['product_details']->id) }}"
                                ...
                                <div class="card mb-4 border">
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="col-md-6 mb-3" id="subcategory_wrapper"
                                            style="display: {{ $data['product_details']->category && $data['product_details']->category->name == 'Sewing Machines' ? 'block' : 'none' }};">
                                            ...
                                            <select name="subcategory_id"
                                                ...
                                                <option value="1"
                                                    {{ old('subcategory_id', $data['product_details']->subcategory_id) == 1 ? 'selected' : '' }}>
                                                    FIBC Machines</option>

                                                <option value="2"
                                                    {{ old('subcategory_id', $data['product_details']->subcategory_id) == 2 ? 'selected' : '' }}>
                                                    Woven Sack Machines</option>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <label class="form-label">Product Url <span
                                                    class="required-star">*</span></label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Hero Media Type <span
                                                    class="required-star">*</span></label>
                                            <select name="media_type" id="media_type_select"
                                                class="form-control @error('media_type') is-invalid @enderror">
                                                <option value="image"
                                                    {{ old('media_type', $data['product_details']->media_type) == 'image' ? 'selected' : '' }}>
                                                    Image</option>
                                                <option value="video"
                                                    {{ old('media_type', $data['product_details']->media_type) == 'video' ? 'selected' : '' }}>
                                                    Video</option>
                                            </select>
                                            @error('media_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        @php
                                            $heroSource = old(
                                                'hero_video_source',
                                                $data['product_details']->hero_video_source ?? 'upload',
                                            );
                                            if (empty($heroSource)) {
                                                $heroSource = 'upload';
                                            }
                                        ...
                                        {{-- HERO VIDEO MODE (independent from the "Product Video" card below) --}}
                                        <div class="col-md-12 mb-3" id="hero_video_wrapper"
                                            style="display: {{ old('media_type', $data['product_details']->media_type) == 'video' ? 'block' : 'none' }};">
                                            <div class="card border">
                                                <div class="card-header bg-light"><strong>Hero Video</strong></div>
                                                <div class="card-body row">
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">Hero Video Source</label>
                                                        <select name="hero_video_source" id="hero_video_source"
                                                            class="form-control @error('hero_video_source') is-invalid @enderror"
                                                            onchange="toggleHeroVideoSource()">
                                                            <option value="upload"
                                                                {{ $heroSource == 'upload' ? 'selected' : '' }}>Upload
                                                                Video</option>
                                                            <option value="youtube"
                                                                {{ $heroSource == 'youtube' ? 'selected' : '' }}>YouTube
                                                                Link</option>
                                                        </select>
                                                        @error('hero_video_source')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>

                                                    <div class="col-md-6 mb-3" id="hero_upload_video_wrapper"
                                                        style="{{ $heroSource == 'youtube' ? 'display:none;' : '' }}">
                                                        <label class="form-label">Select Hero Video</label>
                                                        <input type="file" id="hero_video_file"
                                                            class="form-control @error('hero_uploaded_video_path') is-invalid @enderror"
                                                            accept="video/*" onchange="previewHeroVideo(event)">
                                                        <input type="hidden" name="hero_uploaded_video_path"
                                                            id="hero_uploaded_video_path"
                                                            value="{{ old('hero_uploaded_video_path', $data['product_details']->hero_video_source == 'upload' ? $data['product_details']->hero_video : '') }}">
                                                        @error('hero_uploaded_video_path')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror

                                                        <div class="progress mt-2" id="hero_video_progress_wrapper"
                                                            style="display:none;">
                                                            <div class="progress-bar" id="hero_video_progress_bar"
                                                                role="progressbar" style="width: 0%">0%</div>
                                                        </div>

                                                        <video id="hero_video_preview" controls
                                                            style="margin-top:10px; max-width:100%; {{ !empty($data['product_details']->hero_video) && $data['product_details']->hero_video_source == 'upload' ? '' : 'display:none;' }}">
                                                            @if (!empty($data['product_details']->hero_video) && $data['product_details']->hero_video_source == 'upload')
                                                                <source id="hero_video_preview_src"
                                                                    src="{{ asset('/' . $data['product_details']->hero_video) }}"
                                                                    type="video/mp4">
                                                            @endif
                                                    ...
                                                    <div class="col-md-6 mb-3" id="hero_youtube_link_wrapper"
                                                        style="{{ $heroSource == 'upload' ? 'display:none;' : '' }}">
                                                        <label class="form-label">Hero YouTube Link</label>
                                                        <input type="text" name="hero_youtube_link"
                                                            id="hero_youtube_link"
                                                            class="form-control @error('hero_youtube_link') is-invalid @enderror"
                                                            value="{{ old('hero_youtube_link', $data['product_details']->hero_video_source == 'youtube' ? $data['product_details']->hero_video : '') }}"
                                                            placeholder="Paste YouTube link here">
                                                        @error('hero_youtube_link')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror

                                                        @php
                                                            $heroYoutubeId =
                                                                $data['product_details']->hero_video_source == 'youtube'
                                                                    ? getYoutubeId(
                                                                        $data['product_details']->hero_video ?? '',
                                                                    )
                                                                    : null;
                                                        @endphp
                                                        @if ($heroYoutubeId)
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label class="form-label">Hero Thumbnail Image <span
                                                                class="required-star">*</span></label>
                                                        <input type="file" name="hero_thumbnails_image"
                                                            id="hero_thumbnails_image"
                                                            class="form-control @error('hero_thumbnails_image') is-invalid @enderror"
                                                            onchange="validateAndPreviewHeroThumbnail()">
                                                        @error('hero_thumbnails_image')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                        <div class="mt-2">
                                                            @if (!empty($data['product_details']->hero_thumbnail_image))
                                                                <img src="{{ asset('/' . $data['product_details']->hero_thumbnail_image) }}"
                                                                    id="preview_hero_thumbnails_image"
                                                                    style="max-width: 150px; height: auto;"
                                                                    alt="Current Hero Thumbnail">
                                                            @else
                                                                <img id="preview_hero_thumbnails_image" src="#"
                                                                    alt="Preview"
                                        ...
                                        <div class="col-md-4 mb-3" id="product_images_wrapper"
                                            style="display: {{ old('media_type', $data['product_details']->media_type) == 'video' ? 'none' : 'block' }};">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            @if ($data['product_details']->front_image)
                                                <img id="preview_front_image"
                                                    src="{{ asset('public/admin/product/front_image/' . $data['product_details']->front_image) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="video_source" id="video_source"
                                                    ...
                                                    <option value="upload"
                                                        {{ old('video_source', $data['product_details']->video_source ?? '') == 'upload' ? 'selected' : '' }}>
                                                        Upload Video</option>

                                                    <option value="youtube"
                                                        {{ old('video_source', $data['product_details']->video_source ?? '') == 'youtube' ? 'selected' : '' }}>
                                                        YouTube Link</option>
                                            ...
                                            <div class="col-md-6 mb-3" id="upload_video_wrapper"
                                                ...
                                                <input type="file" id="video_file"
                                                    class="form-control @error('uploaded_video_path') is-invalid @enderror"
                                                ...
                                                <video id="video_preview" controls
                                                    style="margin-top:10px; max-width:100%; {{ !empty($data['product_details']->video) && $data['product_details']->video_source == 'upload' ? '' : 'display:none;' }}">

                                                    @if (!empty($data['product_details']->video) && $data['product_details']->video_source == 'upload')
                                                        <source id="video_preview_src"
                                                            src="{{ asset('/' . $data['product_details']->video) }}"
                                                            type="video/mp4">
                                                    @endif
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <label class="form-label">Select Features <span
                                                        class="required-star">*</span></label>
                                ...
                                <div class="card-body">
                                    ...
                                    <textarea name="product_app_desc" class="form-control @error('product_app_desc') is-invalid @enderror"
                                        id="app_description">{{ old('product_app_desc', $data['product_details']->product_app_desc) }}</textarea>

                                    @error('product_app_desc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <label class="form-label">Select Applications <span
                                                        class="required-star">*</span></label>
                                                ...
                                                <div class="size-selection-container">
                                                    ...
                                                    <div class="d-flex flex-wrap gap-2 mb-3">
                                                        ...
                                                        @php
                                                            ...
                                                            $selectedApplications = old(
                                                                'product_application',
                                                                $data['product_details']->product_applications ?? [],
                                                            );
                                ...
                                <div class="card mb-4 border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <label class="form-label">Upload Product PDF <span
                                                class="required-star">*</span></label>
                                        ...
                                        <div id="pdfPreviewContainer" class="mt-3"
                                            style="display: {{ $data['product_details']->product_pdf ? 'block' : 'none' }};">
                                ...
                                <div class="card mb-4 border">
                                    ...
                                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                        ...
                                        <button type="button" class="btn btn-success btn-sm" id="addUsps">+ Add
                                            More</button>
                                    ...
                                    <div class="card-body" id="UspsWrapper">
                                        ...
                                        <input type="text" name="" id="hidden_product_id"
                                            value="{{ $data['product_details']->id }}" hidden>
                                        ...
                                        @foreach ($data['product_details']->product_usp as $index => $usp)
                                            <div class="row UspsGroup mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @error('product_usp.' . $index . '.description')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="col-md-1 d-flex align-items-end">
                                                    ...
                                                    <button type="button" class="btn btn-danger removeColor"
                                                        {{ count($data['product_details']->product_usp) <= 1 ? 'style=display:none;' : '' }}>-</button>
                                ...
                                <div class="card-body">
                                    ...
                                    <textarea name="product_tech_desc" class="form-control @error('product_tech_desc') is-invalid @enderror"
                                        id="tech_description">{{ old('product_tech_desc', $data['product_details']->product_tech_desc) }}</textarea>

                                    @error('product_tech_desc')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="card mb-4 border">
                                    ...
                                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                        ...
                                        <button type="button" class="btn btn-success btn-sm" id="addtechnicals">+ Add
                                            More</button>
                                        ...
                                        @foreach ($data['product_details']->product_technical as $index => $technical)
                                            <div class="row techinalsGroup mb-3">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <label class="form-label">Parameter <span
                                                            class="required-star">*</span></label>

                                                    <input type="text"
                                                        name="product_technical[{{ $index }}][name]"
                                                    ...
                                                    @error('product_technical.' . $index . '.name')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <label class="form-label">Specifications <span
                                                            class="required-star">*</span></label>
                                                    ...
                                                    @error('product_technical.' . $index . '.description')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="col-md-1 d-flex align-items-end">
                                                    ...
                                                    <button type="button" class="btn btn-danger removeTechnical"
                                                        {{ count($data['product_details']->product_technical) <= 1 ? 'style=display:none;' : '' }}>-</button>
                                ...
                                <div class="card mb-4 border">
                                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                        ...
                                        <button type="button" class="btn btn-success btn-sm" id="addInstallationVideo">+
                                            Add Video</button>
                                    </div>
                                    <div class="card-body" id="installationVideosWrapper"
                                        data-existing='@json($data['product_details']->installation_videos ?? [])'>
                                        {{-- rows JS se yaha inject honge, existing videos auto-load honge --}}
                                    </div>
                                </div>
    ...
    @enderror-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="product_status"
                                                    ...
                                                    <option value="Active"
                                                        {{ old('product_status', $data['product_details']->product_status) == 'Active' ? 'selected' : '' }}>
                                                        Active</option>

                                                    <option value="In-Active"
                                                        {{ old('product_status', $data['product_details']->product_status) == 'In-Active' ? 'selected' : '' }}>
                                                        Inactive</option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label class="form-label">Is this Product Live ? <span
                                                        class="required-star">*</span></label>
                                                ...
                                                <select name="is_live"
                                                    ...
                                                    <option value="1"
                                                        {{ old('is_live', $data['product_details']->is_live) == 1 ? 'selected' : '' }}>
                                                        Yes</option>

                                                    <option value="0"
                                                        {{ old('is_live', $data['product_details']->is_live) == 0 ? 'selected' : '' }}>
                                                        No</option>
                                ...
                                <div class="card-body">
                                    ...
                                    <textarea name="product_short_desc" class="form-control @error('product_short_desc') is-invalid @enderror"
                                ...
                                <div class="card mb-4 border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <textarea name="product_desc" class="form-control @error('product_desc') is-invalid @enderror" rows="4"
                                            id="product_desc">{{ old('product_desc', $data['product_details']->product_desc) }}</textarea>
...
<script>
    ...
    <script>
        ...
        function toggleMediaType() {
            const mediaType = $('#media_type_select').val();
            $('#hero_video_wrapper').toggle(mediaType === 'video');
            $('#product_images_wrapper').toggle(mediaType !== 'video'); // hide Images when video is selected
            if (mediaType === 'video') {
                toggleHeroVideoSource();
            }
        }
        $('#media_type_select').on('change', toggleMediaType);
        toggleMediaType();

        function toggleHeroVideoSource() {
            const source = $('#hero_video_source').val();
            $('#hero_upload_video_wrapper').toggle(source === 'upload');
            $('#hero_youtube_link_wrapper').toggle(source === 'youtube');
        }
        ...
        function previewHeroVideo(event) {
            ...
            const src = document.getElementById('hero_video_preview_src') || document.createElement('source');
            src.id = 'hero_video_preview_src';
            src.src = URL.createObjectURL(file);
            src.type = file.type;
            if (!preview.contains(src)) preview.appendChild(src);
            preview.style.display = 'block';
            preview.load();

            uploadHeroVideoChunked(file);
        }

        function uploadHeroVideoChunked(file) {
            const chunkSize = 2 * 1024 * 1024; // 2MB
            const totalChunks = Math.ceil(file.size / chunkSize);
            const fileName = Date.now() + '_' + file.name.replace(/\s+/g, '_');
            const progressWrapper = document.getElementById('hero_video_progress_wrapper');
            const progressBar = document.getElementById('hero_video_progress_bar');
            ...
            function uploadNextChunk() {
                ...
                $.ajax({
                    url: window.APP_URLS.productvideoUploadChunk,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(res) {
                        ...
                        if (res.success && res.filePath) {
                            document.getElementById('hero_uploaded_video_path').value = res.filePath;
                            progressBar.classList.add('bg-success');
                        } else if (res.success && chunkNumber < totalChunks) {
                            uploadNextChunk();
                        }
                    },
                    error: function() {
        ...
        function validateAndPreviewHeroThumbnail() {
            const file = document.getElementById('hero_thumbnails_image').files[0];
            if (!file) return;
            const preview = document.getElementById('preview_hero_thumbnails_image');
