            ...
            <div class="col-sm-12">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Hero Media Type <span class="required-star">*</span></label>
                        ...
                        @php
                            $heroSource = old('hero_video_source', 'upload');
                        @endphp

                        {{-- HERO VIDEO MODE --}}
                        <div class="col-md-12 mb-3" id="hero_video_wrapper"
                            style="display: {{ old('media_type') == 'video' ? 'block' : 'none' }};">
                                ...
                                <div class="card-body row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="hero_video_source" id="hero_video_source"
                                            ...
                                            <option value="upload" {{ $heroSource == 'upload' ? 'selected' : '' }}>Upload Video</option>
                                            <option value="youtube" {{ $heroSource == 'youtube' ? 'selected' : '' }}>YouTube Link</option>
                                        </select>
                                        @error('hero_video_source')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3" id="hero_upload_video_wrapper"
                                        ...
                                        <input type="hidden" name="hero_uploaded_video_path" id="hero_uploaded_video_path"
                                            value="{{ old('hero_uploaded_video_path') }}">
                                        @error('hero_uploaded_video_path')<div class="invalid-feedback">{{ $message }}</div>@enderror

                                        <div class="progress mt-2" id="hero_video_progress_wrapper" style="display:none;">
                                            <div class="progress-bar" id="hero_video_progress_bar" role="progressbar" style="width: 0%">0%</div>
                                        </div>

                                        <video id="hero_video_preview" controls style="margin-top:10px; max-width:100%; display:none;">
                                            <source id="hero_video_preview_src" src="" type="video/mp4">
                                    ...
                                    <div class="col-md-6 mb-3" id="hero_youtube_link_wrapper"
                                        ...
                                        <input type="text" name="hero_youtube_link" id="hero_youtube_link"
                                            ...
                                            value="{{ old('hero_youtube_link') }}"
                                            placeholder="Paste YouTube link here">
                                        @error('hero_youtube_link')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Hero Thumbnail Image <span class="required-star">*</span></label>
                                        <input type="file" name="hero_thumbnails_image" id="hero_thumbnails_image"
                                            class="form-control @error('hero_thumbnails_image') is-invalid @enderror"
                                            onchange="validateAndPreviewHeroThumbnail()">
                                        @error('hero_thumbnails_image')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        <div class="mt-2">
                                            <img id="preview_hero_thumbnails_image" src="#" alt="Preview"
                        ...
                        <div class="col-md-6 mb-3" id="product_images_wrapper"
                            style="display: {{ old('media_type') == 'video' ? 'none' : 'block' }};">
...
function toggleMediaType() {
    ...
    $('#product_images_wrapper').toggle(mediaType !== 'video');
    if (mediaType === 'video') {
        toggleHeroVideoSource();
    }
}
$('#media_type_select').on('change', toggleMediaType);
$(document).ready(toggleMediaType);
...
function previewHeroVideo(event) {
    ...
    const src = document.getElementById('hero_video_preview_src');
